package br.com.dev.api.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandardError> sqlViolation(SQLConstraintViolationException ex, HttpServletRequest request) {
